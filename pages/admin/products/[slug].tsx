...
const ProductAdminPage:FC<Props> = ({ product }) => {
    ...
    useEffect(() => {
        ...
        return () => subscription.unsubscribe(); // limpiamos la suscripcion al observable watch
    ...
    const onSubmit = async (form: FormData) => {
        ...
        if (form.images.length < 2) return alert('Mínimo de 2 imágenes');
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={ 6 }>
                        ...
                        <TextField
                            ...
                            { ...register('inStock', {
                                required: 'Este campo es requerido',
                                min: { value: 0, message : 'Mínimo valor es de 0' }
                            })}
                    ...
                    <Grid item xs={12} sm={ 6 }>
                        ...
                        <Box display='flex' flexDirection="column">
                            ...
                            <Chip 
                                ...
                                color='error'
                                variant='outlined'
                                sx={{ display: getValues('images').length > 1 ? 'none' : 'flex' }}
                            />
